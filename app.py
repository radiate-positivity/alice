...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if req['request']['nlu']['tokens'] in [['правила'], ['помощь']]:
        ...
        elif  req['request']['nlu']['tokens'] == ['что', 'ты', 'умеешь']:
            res['response']['text'] = 'Вы задаёте слишком много вопросов... И это довольно странный вопрос для навыка "Игра 21 очко". Я умею играть в 21 очко, если интернет у вас есть, а карт нет. Я настолько огорчен таким вопросом, что даже кнопки уберу, сами теперь пишите' 
        ...
        if not sessionStorage[user_id]['game_started']:
            if 'да' in req['request']['nlu']['tokens']:
                ...
                res['response']['text'] = 'Так вы хотите сыграть?'
                res['response']['buttons'] = [
                    {
                        'title': 'Да',
                        'hide': True
